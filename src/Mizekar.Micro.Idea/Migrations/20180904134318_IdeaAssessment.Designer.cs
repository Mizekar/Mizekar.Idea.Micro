...
namespace Mizekar.Micro.Idea.Migrations
{
    ...
    [Migration("20180904134318_Idea Assessment")]
    partial class IdeaAssessment
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mizekar.Micro.Idea.Data.Entities.IdeaAssessmentOptionSelection", b =>
                {
                    b.Property<Guid>("Id");
                    ...
                    b.Property<Guid>("IdeaAssessmentOptionSetId");

                    b.Property<Guid>("IdeaAssessmentOptionSetItemId");
                    ...
                    b.HasIndex("IdeaAssessmentOptionSetId");

                    b.HasIndex("IdeaAssessmentOptionSetItemId");

                    b.HasIndex("IdeaId");

                    b.ToTable("IdeaAssessmentOptionSelections");
                });

            modelBuilder.Entity("Mizekar.Micro.Idea.Data.Entities.IdeaAssessmentOptionSet", b =>
                {
                    b.Property<Guid>("Id");
                    ...
                    b.ToTable("IdeaAssessmentOptionSets");
                });

            modelBuilder.Entity("Mizekar.Micro.Idea.Data.Entities.IdeaAssessmentOptionSetItem", b =>
                {
                    b.Property<Guid>("Id");
                    ...
                    b.ToTable("IdeaAssessmentOptionSetItems");
                });

            modelBuilder.Entity("Mizekar.Micro.Idea.Data.Entities.IdeaAssessmentScore", b =>
                {
                    b.Property<Guid>("Id");
                    ...
                    b.ToTable("IdeaAssessmentScores");
                });
            ...
            modelBuilder.Entity("Mizekar.Micro.Idea.Data.Entities.IdeaAssessmentOptionSelection", b =>
                {
                    b.HasOne("Mizekar.Micro.Idea.Data.Entities.IdeaAssessmentOptionSet", "IdeaAssessmentOptionSet")
                        .WithMany()
                        .HasForeignKey("IdeaAssessmentOptionSetId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Mizekar.Micro.Idea.Data.Entities.IdeaAssessmentOptionSetItem", "IdeaAssessmentOptionSetItem")
                        .WithMany("IdeaAssessmentOptionSetRelations")
                        .HasForeignKey("IdeaAssessmentOptionSetItemId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Mizekar.Micro.Idea.Data.Entities.IdeaInfo", "Idea")
                        .WithMany("IdeaAssessmentOptionSelections")
                        .HasForeignKey("IdeaId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("Mizekar.Micro.Idea.Data.Entities.IdeaAssessmentOptionSetItem", b =>
                {
                    b.HasOne("Mizekar.Micro.Idea.Data.Entities.IdeaAssessmentOptionSet", "IdeaAssessmentOptionSet")
                        .WithMany("IdeaAssessmentOptionSetItems")
                        .HasForeignKey("IdeaAssessmentOptionSetId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
