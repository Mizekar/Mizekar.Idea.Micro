...
#pragma warning disable // Disable all warnings
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "11.17.15.0 (NJsonSchema v9.10.53.0 (Newtonsoft.Json v9.0.0.0))")]
    public partial interface IIdeasClient
    {
        /// <summary>Get ideas</summary>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<PagedOfIdeaViewPoco> GetideasAsync(int pageNumber, int pageSize);

        /// <summary>Get ideas</summary>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        System.Threading.Tasks.Task<PagedOfIdeaViewPoco> GetideasAsync(int pageNumber, int pageSize, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class IdeasClient : IIdeasClient
    {
        ...
        /// <summary>Get ideas</summary>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<PagedOfIdeaViewPoco> GetideasAsync(int pageNumber, int pageSize)
        {
            return GetideasAsync(pageNumber, pageSize, System.Threading.CancellationToken.None);
        }

        /// <summary>Get ideas</summary>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task<PagedOfIdeaViewPoco> GetideasAsync(int pageNumber, int pageSize, System.Threading.CancellationToken cancellationToken)
        {
            if (pageNumber == null)
    ...
    public partial class OperationalPhasesClient : IOperationalPhasesClient
    {
        ...
        public OperationalPhasesClient()
        {
            _settings = new System.Lazy<Newtonsoft.Json.JsonSerializerSettings>(() =>
            {
                var settings = new Newtonsoft.Json.JsonSerializerSettings();
